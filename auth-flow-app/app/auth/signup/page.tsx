  ...
  return (
    ...
    >
      <form
        ...
        className="space-y-5 flex flex-col gap-2 items-center justify-center"
      >
        {/* Name Input */}
        ...
        <div className="space-y-3 flex gap-4">
          <button
            type="button"
            className="w-1/2 flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
          >
